...
class JAX_Transformers_BEiT_Base_Patch16_224(JAXAbstractClass):
  def __init__(self):
    self.processor = BeitImageProcessor.from_pretrained('microsoft/beit-base-patch16-224')
    self.model = FlaxBeitForImageClassification.from_pretrained('microsoft/beit-base-patch16-224') 
