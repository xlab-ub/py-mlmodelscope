...
class MXNet_Faster_RCNN_ResNet50_v1b_VOC(MXNetAbstractClass):
  ...
  def postprocess(self, model_output):
    ...
    for cur_probs, cur_labels, cur_boxes in zip(*model_output):
      ...
      cur_boxes_normalized = [[b[1] / 300, b[0] / 400, b[3] / 300, b[2] / 400] for b in cur_boxes]

      probs.append(list(cur_probs))
      labels.append(list(cur_labels))
      boxes.append(list(cur_boxes_normalized))
