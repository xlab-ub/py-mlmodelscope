...
class MXNet_SSD_512_MobileNet_1_0_COCO:
  def __init__(self, architecture):
    temp_path = os.path.join(pathlib.Path(__file__).resolve().parent.parent.parent, 'tmp') 
    if not os.path.isdir(temp_path): 
      os.mkdir(temp_path) 

    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_object_detection/mxnet/SSD_512_MobileNet_1.0_COCO.yml 
    self.inLayer = ['data'] 

    model_symbol_url = "http://s3.amazonaws.com/store.carml.org/models/mxnet/gluoncv/ssd_512_mobilenet1.0_coco/model-symbol.json" 
    model_params_url = "http://s3.amazonaws.com/store.carml.org/models/mxnet/gluoncv/ssd_512_mobilenet1.0_coco/model-0000.params" 
    ...
    features_file_url = "https://s3.amazonaws.com/store.carml.org/synsets/coco/coco_labels_2014_2017.txt" 
...
def init(architecture):
  return MXNet_SSD_512_MobileNet_1_0_COCO(architecture) 
