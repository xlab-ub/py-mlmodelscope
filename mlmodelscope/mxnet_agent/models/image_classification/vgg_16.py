...
class MXNet_VGG_16:
  def __init__(self, architecture):
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_classification/mxnet/vgg/VGG_16.yml 
    self.inLayer = ['data'] 

    model_symbol_url = "http://s3.amazonaws.com/store.carml.org/models/mxnet/gluoncv/vgg16/model-symbol.json" 
    model_params_url = "http://s3.amazonaws.com/store.carml.org/models/mxnet/gluoncv/vgg16/model-0000.params" 
...
def init(architecture):
  return MXNet_VGG_16(architecture) 
