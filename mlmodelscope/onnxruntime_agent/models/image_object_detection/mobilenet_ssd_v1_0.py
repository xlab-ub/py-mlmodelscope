...
class ONNXRuntime_MobileNet_SSD_V1_0:
  ...
  def __init__(self, providers):
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_object_detection/onnxruntime/mobilenet/MobileNet_SSD_v1.0.yml 
    model_file_url = "https://s3.amazonaws.com/store.carml.org/models/onnxruntime/mb1-ssd.onnx" 
...
def init(providers):
  return ONNXRuntime_MobileNet_SSD_V1_0(providers) 
