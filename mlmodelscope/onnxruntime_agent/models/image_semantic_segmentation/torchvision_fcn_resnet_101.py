...
class ONNXRuntime_TorchVision_FCN_Resnet_101: 
  def __init__(self, providers):
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_semantic_segmentation/onnxruntime/TorchVision_FCN_Resnet_101.yml 
...
def init(providers):
  return ONNXRuntime_TorchVision_FCN_Resnet_101(providers) 
