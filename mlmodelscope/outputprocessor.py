    ...
    def process_final_outputs_for_serialization(modality, final_outputs, model_features=None): 
        if ((model_features is None) 
            and (modality not in ['image_enhancement', 'image_generation', 'image_synthesis', 'image_editing', 
                                  ...
                                  'text_to_code', 'text_to_text', 'automatic_speech_recognition', 'audio_to_text', 'audio_diarization', 'visual_question_answering'])):
        ...
        elif modality in ['text_to_code', 'text_to_text', 'automatic_speech_recognition', 'audio_to_text', 'audio_diarization', 'visual_question_answering']:
            for idx, output in enumerate(final_outputs): 
