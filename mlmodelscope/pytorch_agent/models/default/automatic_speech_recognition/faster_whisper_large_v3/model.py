...
class PyTorch_Transformers_Whisper_Large_V3(PyTorchAbstractClass):
    def __init__(self, config=None):
        ...
        # The provided model 'Systran/faster-whisper-large-v3' is a CTranslate2 conversion.
        # To create a working PyTorch model, we use the original model it was converted from.
