...
class PyTorch_Transformers_Wav2Vec2_Conformer_Rel_Pos_Large(PyTorchAbstractClass):
  def __init__(self, config=None):
    self.config = config if config else {} 
    self.processor = Wav2Vec2FeatureExtractor.from_pretrained("facebook/wav2vec2-conformer-rel-pos-large") 
    self.model = Wav2Vec2ForCTC.from_pretrained("facebook/wav2vec2-conformer-rel-pos-large") 
