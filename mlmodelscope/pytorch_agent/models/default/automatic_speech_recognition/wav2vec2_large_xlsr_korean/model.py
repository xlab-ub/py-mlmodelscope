...
class PyTorch_Transformers_Wav2Vec2_Xlsr_Korean(PyTorchAbstractClass):
    def __init__(self, config=None):
        ...
        if multi_gpu and device == "cuda":
            self.model = Wav2Vec2ForCTC.from_pretrained("kresnik/wav2vec2-large-xlsr-korean", device_map="auto", torch_dtype="auto")
        else:
            self.model = Wav2Vec2ForCTC.from_pretrained("kresnik/wav2vec2-large-xlsr-korean")
