...
class PyTorch_Transformers_Ahishamm_Skinsam(PyTorchAbstractClass):
    ...
    def postprocess(self, model_output):
        ...
        for output, original_size in zip(model_output, self.original_sizes):
            ...
            if max_val > 0:
                formatted = (output * 255 / max_val).astype("uint8").tolist()
            else:
                formatted = np.zeros_like(output, dtype="uint8").tolist()
