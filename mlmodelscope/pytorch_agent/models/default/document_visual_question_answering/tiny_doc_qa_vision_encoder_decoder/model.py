...
class PyTorch_Transformers_Tiny_Doc_QA_Vision_Encoder_Decoder(PyTorchAbstractClass):
    def __init__(self, config=None):
        self.config = config if config else dict()
        device = self.config.pop("_device", "cpu")
        multi_gpu = self.config.pop("_multi_gpu", False)

        model_id = "optimum-intel-internal-testing/tiny-doc-qa-vision-encoder-decoder"
    ...
    def postprocess(self, model_output):
        ...
        for sequence in sequences:
            ...
            try:
                ...
                # Fallback if token2json fails or doesn't produce the expected structure
