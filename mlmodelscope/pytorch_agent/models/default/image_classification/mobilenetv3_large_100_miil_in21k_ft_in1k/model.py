...
class Timm_MobileNetV3_Large_100_MIIL_IN21K_FT_IN1K(PyTorchAbstractClass):
    def __init__(self, config=None):
        self.config = config if config else dict()
        device = self.config.pop("_device", "cpu")
        multi_gpu = self.config.pop("_multi_gpu", False) # timm doesn't have a simple device_map

        model_id = "mobilenetv3_large_100.miil_in21k_ft_in1k"
