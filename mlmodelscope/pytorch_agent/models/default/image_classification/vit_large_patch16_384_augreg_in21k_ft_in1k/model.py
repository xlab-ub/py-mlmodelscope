...
class PyTorch_Timm_ViT_Large_Patch16_384(PyTorchAbstractClass):
    def __init__(self, config=None):
        self.config = config if config else dict()
        device = self.config.pop("_device", "cpu")
        multi_gpu = self.config.pop("_multi_gpu", False)

        model_id = "timm/vit_large_patch16_384.augreg_in21k_ft_in1k"
        ...
        self.preprocessor = create_transform(**data_config, is_training=False)
