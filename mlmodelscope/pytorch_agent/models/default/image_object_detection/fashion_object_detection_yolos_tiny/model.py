...
class PyTorch_Transformers_YolosTiny(PyTorchAbstractClass):
    def __init__(self, config=None):
        ...
        model_id = 'yainage90/fashion-object-detection-yolos-tiny'
    ...
    def postprocess(self, model_output):
        results = self.processor.post_process_object_detection(model_output, threshold=0.85, target_sizes=self.target_sizes)[0]
