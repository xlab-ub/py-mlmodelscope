...
class PyTorch_Transformers_Mask2Former_Swin_Tiny_Cityscapes(PyTorchAbstractClass):
    ...
    def preprocess(self, input_images):
        ...
        self.target_sizes = [image.size[::-1] for image in images]
    ...
    def postprocess(self, model_output):
        ...
        return [p.cpu().numpy().tolist() for p in predicted_semantic_maps]
