...
class PyTorch_Transformers_Mask2Former_Swin_Tiny_Coco_Instance(PyTorchAbstractClass):
    ...
    def postprocess(self, model_output):
        # Mask2FormerOutput directly provides semantic segmentation maps
        # of shape (batch_size, height, width).
        return model_output.semantic_segmentation.tolist()
