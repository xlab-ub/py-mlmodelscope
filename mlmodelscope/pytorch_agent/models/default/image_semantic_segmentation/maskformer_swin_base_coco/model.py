...
class PyTorch_Transformers_MaskFormer_Swin_Base_COCO(PyTorchAbstractClass):
    ...
    def postprocess(self, model_output):
        segmentation_maps = self.processor.post_process_semantic_segmentation(model_output)
        return [seg_map.tolist() for seg_map in segmentation_maps]
