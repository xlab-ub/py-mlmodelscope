...
class PyTorch_Transformers_YarnGPT2(PyTorchAbstractClass):
    def __init__(self, config=None):
        ...
        self.max_new_tokens = self.config.pop('max_new_tokens', 1024)
    ...
    def predict(self, model_input):
        return self.model.generate(**model_input, max_new_tokens=self.max_new_tokens, **self.config)
