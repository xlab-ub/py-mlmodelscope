...
class PyTorch_Transformers_Bart_Large_Emojilm(PyTorchAbstractClass):
    def __init__(self, config=None):
        self.config = config if config else {}

        model_id = "KomeijiForce/bart-large-emojilm"
        ...
        self.tokenizer = BartTokenizer.from_pretrained(model_id, **tokenizer_args)
        self.model = BartForConditionalGeneration.from_pretrained(model_id, **model_args)
