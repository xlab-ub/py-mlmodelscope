...
class PyTorch_Transformers_Bert_Base_German_Cased(PyTorchAbstractClass):
    def __init__(self, config=None):
        ...
        self.tokenizer = BertTokenizer.from_pretrained(model_id, **tokenizer_args)
        self.model = BertForMaskedLM.from_pretrained(model_id, **model_args)
