...
class PyTorch_Transformers_Bigbird_Pegasus_Large_Pubmed(PyTorchAbstractClass):
    def __init__(self, config=None):
        ...
        self.model = BigBirdPegasusForConditionalGeneration.from_pretrained(model_id, **model_args)
