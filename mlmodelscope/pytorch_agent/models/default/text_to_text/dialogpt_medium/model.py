...
class PyTorch_Transformers_Dialogpt_Medium(PyTorchAbstractClass):
    ...
    def preprocess_chat(self, input_texts):
        ...
        text_to_encode = self.tokenizer.eos_token.join(formatted_messages) + self.tokenizer.eos_token
        encoded = self.tokenizer(text_to_encode, return_tensors="pt")
