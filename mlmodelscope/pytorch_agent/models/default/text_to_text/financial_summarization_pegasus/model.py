...
class PyTorch_Transformers_Financial_Summarization_Pegasus(PyTorchAbstractClass):
    def __init__(self, config=None):
        ...
        self.tokenizer = PegasusTokenizer.from_pretrained(model_id, **tokenizer_args)
        self.model = PegasusForConditionalGeneration.from_pretrained(model_id, **model_args)
