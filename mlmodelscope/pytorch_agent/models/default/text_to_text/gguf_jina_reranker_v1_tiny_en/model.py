...
class PyTorch_Transformers_Gguf_Jina_Reranker_V1_Tiny_En(PyTorchAbstractClass):
    def __init__(self, config=None):
        ...
        model_id = "Felladrin/gguf-jina-reranker-v1-tiny-en"
        ...
        self.model = AutoModelForSequenceClassification.from_pretrained(model_id, **model_args)
