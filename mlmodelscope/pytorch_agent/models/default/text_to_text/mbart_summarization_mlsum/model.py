...
class PyTorch_Transformers_Mbart_Summarization_Mlsum(PyTorchAbstractClass):
    def __init__(self, config=None):
        ...
        model_id = "ARTeLab/mbart-summarization-mlsum"
        ...
        self.tokenizer = MBartTokenizer.from_pretrained(model_id, **tokenizer_args)
        self.model = MBartForConditionalGeneration.from_pretrained(model_id, **model_args)
