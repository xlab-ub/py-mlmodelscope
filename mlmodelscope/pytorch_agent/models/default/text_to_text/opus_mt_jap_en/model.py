...
class PyTorch_Transformers_Opus_Mt_Jap_En(PyTorchAbstractClass):
    def __init__(self, config=None):
        ...
        model_id = "Helsinki-NLP/opus-mt-jap-en"
        ...
        self.tokenizer = MarianTokenizer.from_pretrained(model_id, **tokenizer_args)
        self.model = MarianMTModel.from_pretrained(model_id, **model_args)
