...
class PyTorch_Transformers_Qwen3_32b(PyTorchAbstractClass):
    def __init__(self, config=None):
        ...
        self.max_new_tokens = self.config.get("max_new_tokens", 32768)
    ...
    def preprocess_chat(self, input_texts):
        ...
        encoded = self.tokenizer.apply_chat_template(formatted_messages, return_dict=True, return_tensors="pt", add_generation_prompt=True, enable_thinking=True)
    ...
    def postprocess_chat(self, model_output):
        ...
        output_ids = model_output[0][self.input_ids_shape[-1]:].tolist()
        try:
