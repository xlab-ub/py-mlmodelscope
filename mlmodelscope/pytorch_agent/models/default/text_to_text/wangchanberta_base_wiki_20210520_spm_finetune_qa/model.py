...
class PyTorch_Transformers_Wangchanberta_Base_Wiki_20210520_Spm_Finetune_Qa(PyTorchAbstractClass):
    def __init__(self, config=None):
        ...
        model_id = "airesearch/wangchanberta-base-wiki-20210520-spm-finetune-qa"
        ...
        self.model = AutoModelForQuestionAnswering.from_pretrained(model_id, **model_args)
