...
class PyTorch_Transformers_Wmt19_Ru_En(PyTorchAbstractClass):
    def __init__(self, config=None):
        ...
        self.tokenizer = FSMTTokenizer.from_pretrained(model_id, **tokenizer_args)
        self.model = FSMTForConditionalGeneration.from_pretrained(model_id, **model_args)
