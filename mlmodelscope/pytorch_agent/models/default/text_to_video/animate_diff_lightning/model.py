...
#     return self.model(prompt="spider man", guidance_scale=self.guidance_scale, num_inference_steps=self.step)
...
class PyTorch_Transformers_Text_To_Video_Ms_1_7b(PyTorchAbstractClass):
  ...
  def predict(self, model_input): 
    return self.model(prompt="spider man", guidance_scale=self.guidance_scale, num_inference_steps=25)
