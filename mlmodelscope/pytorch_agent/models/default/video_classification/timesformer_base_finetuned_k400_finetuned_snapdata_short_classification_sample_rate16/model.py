...
class PyTorch_Transformers_Timesformer_Base_Finetuned_K400_Snapdata(PyTorchAbstractClass):
    def __init__(self, config=None):
        self.config = config if config else dict()
        device = self.config.pop("_device", "cpu")
        multi_gpu = self.config.pop("_multi_gpu", False)

        model_id = "Kartikeya/timesformer-base-finetuned-k400-finetuned-snapdata_short_classification-sample_rate16"
