...
class PyTorch_Transformers_TimeSformer_Base_Finetuned_K600(PyTorchAbstractClass):
    def __init__(self, config=None):
        self.config = config if config else dict()
        device = self.config.pop("_device", "cpu")
        multi_gpu = self.config.pop("_multi_gpu", False)

        model_id = "facebook/timesformer-base-finetuned-k600"
    ...
    def preprocess(self, input_videos):
        ...
        # The model expects 8 frames, so we sample 8 frames.
