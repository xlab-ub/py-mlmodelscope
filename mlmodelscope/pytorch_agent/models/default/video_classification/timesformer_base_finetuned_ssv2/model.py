...
class PyTorch_Transformers_Timesformer_Base_Finetuned_Ssv2(PyTorchAbstractClass):
    ...
    def preprocess(self, input_videos):
        ...
        # The processor expects a list of frames (PIL images or numpy arrays).
        inputs = self.processor(images=list(video), return_tensors="pt")
        return inputs
