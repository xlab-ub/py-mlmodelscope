...
class PyTorch_Transformers_Videomae_Base_Finetuned_Kinetics_Finetuned_Violence_Subset(PyTorchAbstractClass):
    def __init__(self, config=None):
        self.config = config if config else dict()
        device = self.config.pop("_device", "cpu")
        multi_gpu = self.config.pop("_multi_gpu", False)

        model_id = "parksy1314/videomae-base-finetuned-kinetics-finetuned-violence-subset"
