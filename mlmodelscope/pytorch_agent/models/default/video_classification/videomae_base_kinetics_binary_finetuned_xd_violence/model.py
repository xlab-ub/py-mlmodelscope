...
class PyTorch_Transformers_VideoMAE_Base_Kinetics_Binary_Finetuned_XD_Violence(PyTorchAbstractClass):
    def __init__(self, config=None):
        self.config = config if config else dict()
        device = self.config.pop("_device", "cpu")
        multi_gpu = self.config.pop("_multi_gpu", False)

        model_id = "mitegvg/videomae-base-kinetics-binary-finetuned-xd-violence"
