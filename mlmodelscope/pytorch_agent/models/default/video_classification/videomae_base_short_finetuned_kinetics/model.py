...
class PyTorch_Transformers_VideoMAE_Base_Short_Finetuned_Kinetics(PyTorchAbstractClass):
    def __init__(self, config=None):
        self.config = config if config else dict()
        device = self.config.pop("_device", "cpu")
        multi_gpu = self.config.pop("_multi_gpu", False)

        model_id = "MCG-NJU/videomae-base-short-finetuned-kinetics"
    ...
    def preprocess(self, input_videos):
        ...
        # processor expects a list of frames
