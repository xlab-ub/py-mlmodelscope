...
class PyTorch_Transformers_VideoMAE_Shawon16_Kinetics_10class(PyTorchAbstractClass):
    def __init__(self, config=None):
        self.config = config if config else dict()
        device = self.config.pop("_device", "cpu")
        multi_gpu = self.config.pop("_multi_gpu", False)

        model_id = "Shawon16/VideoMAE_fold__0__20_epoch_p5_bdslw60_kinetics_check_longtail_10class"
