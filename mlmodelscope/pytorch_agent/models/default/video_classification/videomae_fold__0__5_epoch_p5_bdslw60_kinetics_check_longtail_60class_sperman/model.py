...
class PyTorch_Transformers_VideoMAE_fold__0__5_epoch_p5_bdslw60_kinetics_check_longtail_60class_sperman(PyTorchAbstractClass):
    def __init__(self, config=None):
        self.config = config if config else dict()
        device = self.config.pop("_device", "cpu")
        multi_gpu = self.config.pop("_multi_gpu", False)

        model_id = "Shawon16/VideoMAE_fold__0__5_epoch_p5_bdslw60_kinetics_check_longtail_60class_sperman"
