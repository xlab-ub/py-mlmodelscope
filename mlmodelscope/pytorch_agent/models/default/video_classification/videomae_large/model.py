...
class PyTorch_Transformers_VideoMAE_Large(PyTorchAbstractClass):
    ...
    def preprocess(self, input_videos):
        ...
        indices = self.sample_frame_indices(clip_len=num_frames, frame_sample_rate=4, seg_len=container.streams.video[0].frames)
