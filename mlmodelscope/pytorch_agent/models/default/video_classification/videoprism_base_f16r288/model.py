...
class PyTorch_Transformers_VideoPrism_Base_F16R288(PyTorchAbstractClass):
    def __init__(self, config=None):
        ...
        if multi_gpu and device == "cuda":
            self.model = VideoPrismForVideoClassification.from_pretrained(model_id, device_map="auto", torch_dtype="auto", ignore_mismatched_sizes=True)
        else:
            self.model = VideoPrismForVideoClassification.from_pretrained(model_id, ignore_mismatched_sizes=True)
    ...
    def preprocess(self, input_videos):
        ...
        # sample 16 frames for VideoPrism-B as mentioned in the model card
