...
class Caffe_ResNet_101:
  def __init__(self):
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_classification/pytorch/resnet/Caffe_ResNet_101.yml 
