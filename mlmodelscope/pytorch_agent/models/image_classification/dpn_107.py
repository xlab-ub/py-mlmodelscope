...
class DPN_107: 
  def __init__(self):
    ...
    self.model = DPN(num_init_features=128, k_r=200, groups=50,
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_classification/pytorch/dpn/DPN_107.yml 
