...
class DPN_68_v2_0: 
  def __init__(self):
    ...
    self.model = DPN(small=True, num_init_features=10, k_r=128, groups=32,
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_classification/pytorch/dpn/DPN_68_v2.0.yml 
