...
class DPN_92: 
  def __init__(self):
    ...
    self.model = DPN(num_init_features=64, k_r=96, groups=32,
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_classification/pytorch/dpn/DPN_92.yml 
