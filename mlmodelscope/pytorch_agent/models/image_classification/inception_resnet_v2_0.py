...
class Inception_ResNet_v2_0: 
  def __init__(self):
    ...
    self.model = InceptionResNetV2(num_classes=1001) 
    self.model.load_state_dict(torch.load(model_path)) 

    new_last_linear = nn.Linear(1536, 1000) 
    new_last_linear.weight.data = self.model.last_linear.weight.data[1:] 
    new_last_linear.bias.data = self.model.last_linear.bias.data[1:] 
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_classification/pytorch/inception/Inception_ResNet_v2.0.yml 
