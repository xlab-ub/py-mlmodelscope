...
class SE_ResNet_50: 
  def __init__(self):
    ...
    self.model = SENet(SEResNetBottleneck, [3, 4, 6, 3], groups=1, reduction=16,
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_classification/pytorch/senet/SE_ResNet_50.yml 
