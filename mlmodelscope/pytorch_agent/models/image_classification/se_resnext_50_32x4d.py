...
class SE_ResNext_50_32x4D: 
  def __init__(self):
    ...
    self.model = SENet(SEResNeXtBottleneck, [3, 4, 6, 3], groups=32, reduction=16,
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_classification/pytorch/senet/SE_ResNext_50_32x4D.yml 
