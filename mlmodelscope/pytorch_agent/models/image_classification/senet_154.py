...
class SENet_154: 
  def __init__(self):
    ...
    self.model = SENet(SEBottleneck, [3, 8, 36, 3], groups=64, reduction=16,
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_classification/pytorch/senet/SENet_154.yml 
