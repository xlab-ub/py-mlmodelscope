...
class TorchVision_SqueezeNet_v1_0:
  def __init__(self):
    ...
    if not os.path.isdir(temp_path): 
      os.mkdir(temp_path) 
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_classification/pytorch/torchvision/squeezenet/TorchVision_SqueezeNet_v1.0.yml 
...
def init():
  return TorchVision_SqueezeNet_v1_0()
