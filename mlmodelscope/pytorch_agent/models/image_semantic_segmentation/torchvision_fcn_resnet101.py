...
class TorchVision_Fcn_Resnet101: 
  def __init__(self):
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_semantic_segmentation/pytorch/TorchVision_FCN_Resnet_101.yml 
    model_url = 'https://s3.amazonaws.com/store.carml.org/models/pytorch/fcn_resnet101.pt'
...
def init(): 
  return TorchVision_Fcn_Resnet101() 
...
#     '''
#     preprocessor = FCN_ResNet101_Weights.DEFAULT.transforms() 
#     for i in range(len(input_images)): 
#       input_images[i] = preprocessor(Image.open(input_images[i]).convert('RGB')) 
#     model_input = torch.stack(input_images) 
#     return model_input 
