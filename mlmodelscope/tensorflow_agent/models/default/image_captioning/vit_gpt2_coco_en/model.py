...
from transformers import ViTFeatureExtractor, AutoTokenizer, TFVisionEncoderDecoderModel
from PIL import Image 

class TensorFlow_Transformers_ViT_GPT2_COCO_EN(TensorFlowAbstractClass):
  def __init__(self, config=None):
    ...
    self.model = TFVisionEncoderDecoderModel.from_pretrained("ydshieh/vit-gpt2-coco-en") 
  ...
  def preprocess(self, input_images):
    ...
    model_input = self.feature_extractor(input_images, return_tensors="tf").pixel_values 
    return model_input
