...
class TensorFlow_BiT_M_R50x1_ImageNet21K(TensorFlowAbstractClass):
  def __init__(self):
    self.img_size = (224, 224, 3) 
    self.model = tf.keras.Sequential([
      hub.KerasLayer("https://www.kaggle.com/models/google/bit/frameworks/TensorFlow2/variations/m-r50x1-imagenet21k-classification/versions/1")
      ])
