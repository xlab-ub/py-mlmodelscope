...
class TensorFlow_BiT_M_R50x3_ImageNet1K(TensorFlowAbstractClass):
  def __init__(self):
    self.img_size = (224, 224, 3) 
    self.model = tf.keras.Sequential([
      hub.KerasLayer("https://www.kaggle.com/models/google/bit/frameworks/TensorFlow2/variations/m-r50x3-ilsvrc2012-classification/versions/1")
      ])
