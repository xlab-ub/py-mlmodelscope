...
class TensorFlow_BiT_S_R152x4_ImageNet1K(TensorFlowAbstractClass):
  def __init__(self):
    self.img_size = (224, 224, 3) 
    self.model = tf.keras.Sequential([
      hub.KerasLayer("https://www.kaggle.com/models/google/bit/frameworks/TensorFlow2/variations/s-r152x4-ilsvrc2012-classification/versions/1")
      ])
