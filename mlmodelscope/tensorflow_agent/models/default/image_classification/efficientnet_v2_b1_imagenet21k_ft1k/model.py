...
class TensorFlow_EfficientNet_V2_B1_ImageNet21K_ft1K(TensorFlowAbstractClass):
  def __init__(self):
    self.img_size = (240, 240, 3) 
    self.model = tf.keras.Sequential([
      hub.KerasLayer("https://www.kaggle.com/models/google/efficientnet-v2/frameworks/TensorFlow2/variations/imagenet21k-ft1k-b1-classification/versions/1")
      ])
