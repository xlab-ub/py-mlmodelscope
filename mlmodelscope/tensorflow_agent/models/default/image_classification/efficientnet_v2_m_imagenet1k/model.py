...
class TensorFlow_EfficientNet_V2_M_ImageNet1K(TensorFlowAbstractClass):
  def __init__(self):
    self.img_size = (480, 480, 3) 
    self.model = tf.keras.Sequential([
      hub.KerasLayer("https://www.kaggle.com/models/google/efficientnet-v2/frameworks/TensorFlow2/variations/imagenet1k-m-classification/versions/2")
      ])
