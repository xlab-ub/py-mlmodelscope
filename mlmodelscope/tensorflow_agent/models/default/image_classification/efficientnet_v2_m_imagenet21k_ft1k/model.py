...
class TensorFlow_EfficientNet_V2_M_ImageNet21K_ft1K(TensorFlowAbstractClass):
  def __init__(self):
    self.img_size = (480, 480, 3) 
    self.model = tf.keras.Sequential([
      hub.KerasLayer("https://www.kaggle.com/models/google/efficientnet-v2/frameworks/TensorFlow2/variations/imagenet21k-ft1k-m-classification/versions/1")
      ])
