...
class TensorFlow_EfficientNet_V2_S_ImageNet21K(TensorFlowAbstractClass):
  def __init__(self):
    self.img_size = (384, 384, 3) 
    self.model = tf.keras.Sequential([
      hub.KerasLayer("https://www.kaggle.com/models/google/efficientnet-v2/frameworks/TensorFlow2/variations/imagenet21k-s-classification/versions/2")
      ])
