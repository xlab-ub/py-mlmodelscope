...
class TensorFlow_MobileNet_v2_0_35_192(TensorFlowAbstractClass):
  def __init__(self):
    self.img_size = (192, 192, 3) 
    self.model = tf.keras.Sequential([
      hub.KerasLayer("https://www.kaggle.com/models/google/mobilenet-v2/frameworks/TensorFlow2/variations/035-192-classification/versions/2")
      ])
