...
class TensorFlow_MobileNet_v2_0_75_160(TensorFlowAbstractClass):
  def __init__(self):
    self.img_size = (160, 160, 3) 
    self.model = tf.keras.Sequential([
      hub.KerasLayer("https://www.kaggle.com/models/google/mobilenet-v2/frameworks/TensorFlow2/variations/075-160-classification/versions/2")
      ])
