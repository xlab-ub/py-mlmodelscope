...
class TensorFlow_MobileNet_v2_1_0_128(TensorFlowAbstractClass):
  def __init__(self):
    self.img_size = (128, 128, 3) 
    self.model = tf.keras.Sequential([
      hub.KerasLayer("https://www.kaggle.com/models/google/mobilenet-v2/frameworks/TensorFlow2/variations/100-128-classification/versions/2")
      ])
