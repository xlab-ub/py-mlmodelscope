...
class TensorFlow_MobileNet_v2_1_0_128_Quant(TensorFlowAbstractClass):
  def __init__(self):
    self.img_size = (128, 128, 3) 
    model_file_name = 'graph_frozen.pb'
    tgz_file_url = "https://storage.googleapis.com/mobilenet_v2/checkpoints/quantized_v2_128_100.tgz"
    model_path = self.model_file_in_tgz_download(model_file_name, tgz_file_url, 'v2_128_100/') 
