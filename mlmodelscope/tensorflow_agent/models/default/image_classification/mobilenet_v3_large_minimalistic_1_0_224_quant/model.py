...
class TensorFlow_MobileNet_v3_Large_Minimalistic_1_0_224_Quant(TensorFlowAbstractClass):
  def __init__(self):
    self.img_size = (224, 224, 3) 
    model_file_name = 'v3-large-minimalistic_224_1.0_uint8.pb'
    tgz_file_url = "https://storage.googleapis.com/mobilenet_v3/checkpoints/v3-large-minimalistic_224_1.0_uint8.tgz"
    model_path = self.model_file_in_tgz_download(model_file_name, tgz_file_url, 'v3-large-minimalistic_224_1.0_uint8/') 
    
    input_node = 'input' 
    output_node = 'MobilenetV3/Predictions/Reshape' 
