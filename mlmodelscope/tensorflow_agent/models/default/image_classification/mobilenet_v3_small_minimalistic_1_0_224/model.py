...
class TensorFlow_MobileNet_v3_Small_Minimalistic_1_0_224(TensorFlowAbstractClass):
  def __init__(self):
    self.img_size = (224, 224, 3) 
    model_file_name = 'v3-small-minimalistic_224_1.0_float.pb'
    tgz_file_url = "https://storage.googleapis.com/mobilenet_v3/checkpoints/v3-small-minimalistic_224_1.0_float.tgz"
    model_path = self.model_file_in_tgz_download(model_file_name, tgz_file_url, 'v3-small-minimalistic_224_1.0_float/') 
