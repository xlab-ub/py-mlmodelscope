...
class MLPerf_ResNet50_v1_5:
  def __init__(self):
    temp_path = os.path.join(pathlib.Path(__file__).resolve().parent.parent.parent, 'tmp') 
    if not os.path.isdir(temp_path): 
      os.mkdir(temp_path) 

    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_classification/tensorflow/resnet/ResNet_50_v1.yml 
    self.inLayer = 'input_tensor' 
    self.outLayer = 'softmax_tensor' 

    self.inNode = None 
    self.outNode = None 

    model_file_url = "https://zenodo.org/record/2535873/files/resnet50_v1.pb" 
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_classification/tensorflow/mlcommons_inference/MLCommons_ResNet_50_v1.5.yml 
  ...
  def postprocess(self, model_output): 
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_classification/tensorflow/mlcommons_inference/MLCommons_ResNet_50_v1.5.yml#L77 
    return model_output[:, 1:].tolist() 
    
def init():
  return MLPerf_ResNet50_v1_5()
