...
class TensorFlow_MobileNet_v1_0_75_128(TensorFlowAbstractClass):
  def __init__(self):
    model_file_name = 'mobilenet_v1_0.75_128_frozen.pb' 
    tgz_file_url = "https://s3.amazonaws.com/store.carml.org/models/tensorflow/models/mobilenet_v1_2018_08_02/mobilenet_v1_0.75_128.tgz" 
