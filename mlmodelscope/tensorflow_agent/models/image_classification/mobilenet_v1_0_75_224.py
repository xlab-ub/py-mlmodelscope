...
class TensorFlow_MobileNet_v1_0_75_224:
  def __init__(self):
    ...
    model_file_name = 'mobilenet_v1_0.75_224_frozen.pb' 
    model_path = os.path.join(temp_path, model_file_name) 

    if not os.path.exists(model_path): 
      model_file_url = "https://s3.amazonaws.com/store.carml.org/models/tensorflow/models/mobilenet_v1_2018_08_02/mobilenet_v1_0.75_224.tgz" 
...
def init():
  return TensorFlow_MobileNet_v1_0_75_224()
