...
class TensorFlow_MobileNet_v1_1_0_192_Quant(TensorFlowAbstractClass):
  def __init__(self):
    model_file_name = 'mobilenet_v1_1.0_192_quant_frozen.pb' 
    tgz_file_url = "https://s3.amazonaws.com/store.carml.org/models/tensorflow/models/mobilenet_v1_2018_08_02/mobilenet_v1_1.0_192_quant.tgz" 
