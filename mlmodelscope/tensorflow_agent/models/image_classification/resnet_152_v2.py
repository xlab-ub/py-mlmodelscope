...
class TensorFlow_ResNet_101_V2:
  def __init__(self):
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_classification/tensorflow/resnet/ResNet_152_v2.yml 
    self.inLayer = 'input' 
    self.outLayer = 'resnet_v2_152/predictions/Reshape_1' 
