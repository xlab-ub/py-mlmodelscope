...
class TensorFlow_ResNet_50_V1:
  def __init__(self):
    ...
    self.inLayer = 'input' 
    self.outLayer = 'resnet_v1_50/predictions/Reshape_1' 

    self.inNode = None 
    self.outNode = None 

    model_file_url = "https://s3.amazonaws.com/store.carml.org/models/tensorflow/graphs/resnet_v1_50_frozen.pb" 
...
def init():
  return TensorFlow_ResNet_50_V1()
