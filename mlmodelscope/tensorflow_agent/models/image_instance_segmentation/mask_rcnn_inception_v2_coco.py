...
class TensorFlow_Mask_RCNN_Inception_V2_COCO: 
  def __init__(self):
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_instance_segmentation/tensorflow/Mask_RCNN_Inception_v2_COCO.yml 
...
def init(): 
  return TensorFlow_Mask_RCNN_Inception_V2_COCO() 
