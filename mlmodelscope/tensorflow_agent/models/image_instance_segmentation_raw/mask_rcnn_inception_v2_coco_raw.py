...
class TensorFlow_Mask_RCNN_Inception_V2_COCO_Raw: 
  def __init__(self):
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_instance_segmentation_raw/tensorflow/Mask_RCNN_Inception_v2_COCO_Raw.yml 
    ...
    model_file_url = "https://s3.amazonaws.com/store.carml.org/models/tensorflow/models/mask_rcnn_inception_v2_coco_2018_01_28/frozen_inference_graph.pb" 
...
def init(): 
  return TensorFlow_Mask_RCNN_Inception_V2_COCO_Raw() 
