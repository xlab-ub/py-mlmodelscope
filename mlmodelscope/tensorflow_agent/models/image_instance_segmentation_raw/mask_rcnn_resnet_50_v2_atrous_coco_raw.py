...
class TensorFlow_Mask_RCNN_ResNet_50_V2_Atrous_COCO_Raw: 
  def __init__(self):
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_instance_segmentation_raw/tensorflow/Mask_RCNN_ResNet_50_v2_Atrous_COCO_Raw.yml 
...
def init(): 
  return TensorFlow_Mask_RCNN_ResNet_50_V2_Atrous_COCO_Raw() 
