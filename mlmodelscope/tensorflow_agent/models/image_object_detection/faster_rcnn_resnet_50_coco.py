...
class TensorFlow_Faster_RCNN_ResNet_50_COCO: 
  def __init__(self):
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_object_detection/tensorflow/Faster_RCNN_ResNet_50_COCO.yml 
    ...
    model_file_url = "https://s3.amazonaws.com/store.carml.org/models/tensorflow/models/faster_rcnn_resnet50_coco_2018_01_28/frozen_inference_graph.pb" 
...
def init(): 
  return TensorFlow_Faster_RCNN_ResNet_50_COCO() 
