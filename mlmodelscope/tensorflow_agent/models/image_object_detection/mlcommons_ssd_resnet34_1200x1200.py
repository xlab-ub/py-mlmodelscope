...
class TensorFlow_MLCommons_SSD_ResNet34_1200x1200: 
  def __init__(self):
  ...
  def preprocess(self, input_images):
    for i in range(len(input_images)):
      input_images[i] = self.pre_process_coco_resnet34(input_images[i], [1200, 1200, 3], False) 
...
def init(): 
  return TensorFlow_MLCommons_SSD_ResNet34_1200x1200() 
