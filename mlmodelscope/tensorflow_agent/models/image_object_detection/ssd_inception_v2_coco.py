...
class TensorFlow_SSD_Inception_v2_COCO: 
  def __init__(self):
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_object_detection/tensorflow/SSD_Inception_v2_COCO.yml 
    ...
    model_file_url = "https://s3.amazonaws.com/store.carml.org/models/tensorflow/models/ssd_inception_v2_coco_2018_01_28/frozen_inference_graph.pb" 
...
def init(): 
  return TensorFlow_SSD_Inception_v2_COCO() 
