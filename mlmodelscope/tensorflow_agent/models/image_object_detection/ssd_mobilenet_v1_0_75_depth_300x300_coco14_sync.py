...
class TensorFlow_SSD_MobileNet_v1_0_75_Depth_300x300_COCO14_Sync: 
  def __init__(self):
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_object_detection/tensorflow/SSD_MobileNet_v1_0.75_Depth_300x300_COCO14_Sync.yml 
    ...
    model_file_url = "https://s3.amazonaws.com/store.carml.org/models/tensorflow/models/ssd_mobilenet_v1_0.75_depth_300x300_coco14_sync_2018_07_03/frozen_inference_graph.pb" 
...
def init(): 
  return TensorFlow_SSD_MobileNet_v1_0_75_Depth_300x300_COCO14_Sync() 
