...
class TensorFlow_SSD_MobileNet_v1_PPN_Shared_Box_Predictor_300x300_COCO14_Sync: 
  def __init__(self):
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_object_detection/tensorflow/SSD_MobileNet_v1_PPN_Shared_Box_Predictor_300x300_COCO14_Sync.yml 
...
def init(): 
  return TensorFlow_SSD_MobileNet_v1_PPN_Shared_Box_Predictor_300x300_COCO14_Sync() 
