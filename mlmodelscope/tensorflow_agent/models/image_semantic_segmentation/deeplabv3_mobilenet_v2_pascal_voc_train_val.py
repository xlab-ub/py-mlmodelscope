...
class TensorFlow_DeepLabv3_MobileNet_v2_PASCAL_VOC_Train_Val: 
  def __init__(self):
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_semantic_segmentation/tensorflow/DeepLabv3_MobileNet_v2_PASCAL_VOC_Train_Val.yml 
    ...
    model_file_url = "https://s3.amazonaws.com/store.carml.org/models/tensorflow/models/deeplabv3_mnv2_pascal_trainval_2018_01_29/frozen_inference_graph.pb" 
...
def init(): 
  return TensorFlow_DeepLabv3_MobileNet_v2_PASCAL_VOC_Train_Val() 
