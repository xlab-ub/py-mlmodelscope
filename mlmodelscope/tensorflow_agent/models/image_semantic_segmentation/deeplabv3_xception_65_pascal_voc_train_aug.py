...
class TensorFlow_DeepLabv3_Xception_65_PASCAL_VOC_Train_Aug: 
  def __init__(self):
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_semantic_segmentation/tensorflow/DeepLabv3_Xception_65_PASCAL_VOC_Train_Aug.yml 
...
def init(): 
  return TensorFlow_DeepLabv3_Xception_65_PASCAL_VOC_Train_Aug() 
