...
class TensorFlow_DeepLabv3_Xception_65_PASCAL_VOC_Train_Val: 
  def __init__(self):
    ...
    # https://github.com/c3sr/dlmodel/blob/master/models_demo/vision/image_semantic_segmentation/tensorflow/DeepLabv3_Xception_65_PASCAL_VOC_Train_Val.yml 
    ...
    model_file_url = "https://s3.amazonaws.com/store.carml.org/models/tensorflow/models/deeplabv3_pascal_trainval_2018_01_04/frozen_inference_graph.pb" 
...
def init(): 
  return TensorFlow_DeepLabv3_Xception_65_PASCAL_VOC_Train_Val() 
