...
namespace NV {
    namespace Metric {
        namespace Config {
            ...
            bool GetConfigImage(std::string chipName, const std::vector<std::string>& metricNames, std::vector<uint8_t>& configImage, const uint8_t* pCounterAvailabilityImage = NULL)
            {
                std::vector<NVPA_RawMetricRequest> rawMetricRequests;
