...
#
CUdeviceptr_v2 = ctypes.c_uint 
CUdeviceptr = CUdeviceptr_v2    # #< CUDA device pointer# 

CUdevice_v1 = ctypes.c_int      # #< CUDA device#
CUdevice = CUdevice_v1          # #< CUDA device# 

# #< CUDA context# 
class CUctx_st(ctypes.Structure): 
    pass 
CUcontext = ctypes.POINTER(CUctx_st)

# #< CUDA function# 
class CUfunc_st(ctypes.Structure): 
    pass 
CUfunction = ctypes.POINTER(CUfunc_st)
...
# #< CUDA stream# 
class CUstream_st(ctypes.Structure): 
    pass 
CUstream = ctypes.POINTER(CUstream_st) 
...
#
CUaccessProperty = ctypes.c_int 
@export(globals()) 
class CUaccessProperty_(IntEnum): 
...
#
class CUaccessPolicyWindow_v1(ctypes.Structure): 
    _fields_ = [("base_ptr", ctypes.c_void_p),      #*< Starting address of the access policy window. CUDA driver may align it. #
                ("num_bytes", ctypes.c_size_t),     #*< Size in bytes of the window policy. CUDA driver may restrict the maximum size and alignment. #
                ("hitRatio", ctypes.c_float),       #*< hitRatio specifies percentage of lines assigned hitProp, rest are assigned missProp. #
