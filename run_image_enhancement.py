...
def main(): 
  ...
  if parser.parse_known_args()[0].standalone == 'true': 
    ...
    parser.add_argument("--task", type=str, nargs='?', default="image_enhancement", help="The name of the task to predict.") 
    parser.add_argument("--model_name", type=str, nargs='?', default="srgan", help="The name of the model") 
