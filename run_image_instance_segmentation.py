...
def main(): 
  ...
  parser.add_argument("--task", type=str, nargs='?', default="image_instance_segmentation", help="The name of the task to predict.") 
  ...
  parser.add_argument("--model_name", type=str, nargs='?', default="mask_rcnn_inception_v2_coco", help="The name of the model") 
