...
def main(): 
  ...
  if parser.parse_known_args()[0].standalone == 'true': 
    ...
    parser.add_argument("--task", type=str, nargs='?', default="text_to_text", help="The name of the task to predict.") 
    parser.add_argument("--model_name", type=str, nargs='?', default="flan_t5_base", help="The name of the model") 
    ...
    parser.add_argument("--dataset_name", type=str, nargs='?', default="test_text", help="The name of the dataset for predict.") 
