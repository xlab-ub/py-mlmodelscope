...
def main(): 
  ...
  parser.add_argument("--task", type=str, nargs='?', default="translation_english_to_german", help="The name of the task to predict.") 
  ...
  parser.add_argument("--model_name", type=str, nargs='?', default="t5_small", help="The name of the model") 
  ...
  parser.add_argument("--dataset_name", type=str, nargs='?', default="test_translation_text", help="The name of the dataset for predict.") 
