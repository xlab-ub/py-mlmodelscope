...
def main(): 
  ...
  if parser.parse_known_args()[0].standalone == 'true': 
    ...
    parser.add_argument("--task", type=str, nargs='?', default="video_classification", help="The name of the task to predict.") 
    parser.add_argument("--model_name", type=str, nargs='?', default="xclip_base_patch32", help="The name of the model") 
    ...
    parser.add_argument("--dataset_name", type=str, nargs='?', default="test_video", help="The name of the dataset for predict.") 
  ...
  if args.standalone == 'true': 
    ...
    if task in ["image_classification", "sentiment_analysis", "video_classification"]: 
      if detailed: 
        print(outputs) 
      else: 
