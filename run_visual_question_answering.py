...
def main(): 
  ...
  if parser.parse_known_args()[0].standalone == 'true': 
    ...
    parser.add_argument("--task", type=str, nargs='?', default="visual_question_answering", help="The name of the task to predict.") 
    parser.add_argument("--model_name", type=str, nargs='?', default="blip_vqa_base", help="The name of the model") 
    ...
    parser.add_argument("--dataset_name", type=str, nargs='?', default="test_image_and_question", help="The name of the dataset for predict.") 
